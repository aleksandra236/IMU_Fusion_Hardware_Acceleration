...
#define HW_BATCH_SIZE 10  // Number of samples HW processes at once
...
// @param ahrs        AHRS state (for feedback logic)
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
// HW FUNCTION - Sections 5-8 for SINGLE sample
// 
// Alternative version for per-sample processing (used by main.c)
// Processes one sample and returns unnormalized quaternion.
//
// @param ahrs           AHRS state
// @param gx,gy,gz       Gyroscope (deg/s)
// @param ax,ay,az       Accelerometer (g)
// @param halfGravity*   Half gravity vector from SW Section 4
// @param deltaTime      Time step (s)
// @param newQ*          Output quaternion (unnormalized)
//------------------------------------------------------------------------------
