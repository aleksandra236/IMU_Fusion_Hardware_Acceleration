 ...
 *   4. Notify sensor_ready (sample-by-sample).
 *
...
private:
    ...
    uint32_t total_samples;  // ukupno poslatih uzoraka

    // Internal buffer: jedan sirovi uzorak (6 floats)
    float raw_buffer[RAW_SENSOR_WORDS];
};
